...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Zsuzsa\\HCCCL\\TerKepEsz_Tasks\\computer_based_tasks\\longTRK_Phase2\\longTRK2_APS_MR\\terkepesz_session1.py',
...
rest_instructions_text = visual.TextStim(win=win, name='rest_instructions_text',
    ...
    font='Arial',
    pos=(0, 0), height=0.05, wrapWidth=1.1, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=0.0);
...
rest_instructions_continue = visual.TextStim(win=win, name='rest_instructions_continue',
    text='Ha minden rendben nyomja le a gombot a jobb hüvelykujjával. ',
    font='Arial',
    pos=(0, -0.4), height=0.05, wrapWidth=0.9, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0);
...
prepare_task_button_text = visual.TextStim(win=win, name='prepare_task_button_text',
    text='Ha minden rendben, nyomja le a gombot a jobb hüvelykujjával. ',
    font='Arial',
    pos=(0.0, -0.2), height=0.05, wrapWidth=0.8, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-3.0);
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if rest_instructions_continue.status == NOT_STARTED and tThisFlip >= 5.0-frameTolerance:
        # keep track of start time/frame for later
